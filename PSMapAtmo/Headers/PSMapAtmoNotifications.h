...
// API
#define PSMAPATMO_RECEIVED_AUTH_URL             @"PSMAPATMO_RECEIVED_AUTH_URL"
#define PSMAPATMO_RECEIVED_REDIRECT_URL         @"PSMAPATMO_RECEIVED_REDIRECT_URL"

// ACOUNT
#define PSMAPATMO_ACCOUNT_UPDATE_NOTIFICATION   @"PSMAPATMO_ACCOUNT_UPDATE_NOTIFICATION"

// DEVICE
#define PSMAPATMO_DEVICE_UPDATE_NOTIFICATION    @"PSMAPATMO_DEVICE_UPDATE_NOTIFICATION"

// UPDATE
#define PSMAPATMO_USER_UPDATE_NOTIFICATION      @"PSMAPATMO_USER_UPDATE_NOTIFICATION"
...
#define PSMAPATMO_NOTIFICATIONS     @[PSMAPATMO_API_DATA_RECEIVED, PSMAPATMO_RECEIVED_AUTH_URL, PSMAPATMO_ACCOUNT_UPDATE_NOTIFICATION, PSMAPATMO_DEVICE_UPDATE_NOTIFICATION, PSMAPATMO_USER_UPDATE_NOTIFICATION, PSMAPATMO_USER_UPDATE_NOTIFICATION, PSMAPATMO_PUBLIC_MEASURES_UPDATE_NOTIFICATION, PSMAPATMO_PUBLIC_DEVICE_ADDED_NOTIFICATION]

// MAP
#define PSMAPATMO_PUBLIC_MAP_CHANGED_NOTIFICATION       @"PSMAPATMO_PUBLIC_MAP_CHANGED_NOTIFICATION"
#define PSMAPATMO_PUBLIC_MAP_FINISHED_DRAGGING          @"PSMAPATMO_PUBLIC_MAP_FINISHED_DRAGGING"
